...
export default {
  ...
  mounted () {
    ...
    this.cropper = new Cropper(image, {
      ...
      viewMode: this.widthRatio / this.heightRatio,
      background: false,
      zoomable: false,
      ready: function () {
        self.croppable = true
  ...
  methods: {
    ...
    postImg () {
      let _this = this
      let canvas = _this.cropper.getCroppedCanvas({
        width: this.width * this.rate,
        height: this.width * this.rate
      })
      if (this.cropper) {
        canvas.toBlob(function (blob) {
          let imgData = new FormData()
          imgData.append('file', blob, 'test.jpg')
          console.log(imgData)
